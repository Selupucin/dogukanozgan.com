// @do/db — sunucu logları için PII-güvenli hata redaksiyonu (docs/13 §D3).
//
...
// nested payload/PII loglanmaz. apps/web/src/lib/log-error.ts ile aynı yaklaşım,
// paylaşılan paket (db) tarafında — admin + db ortak kullanır.
